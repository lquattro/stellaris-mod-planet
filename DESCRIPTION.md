...
[h1]-___Stellaris Verions 1.4.*___-[/h1]
...
[h1]Compatible with other mod : size of the galaxy
...
[i]EN : This mod is not recommended for new player (it breaks the game mechanics sectors).[/i]
[i]FR : Ce mode n'est pas recommandé pour les nouveaux joueurs (il casse un peu la mécanique de secteur du jeu).[/i]
...
[u]Compatible[/u] : Game version 1.2.*, 1.3.* and 1.4.*
...
[u]Manual Operation Instruction :[/u]
